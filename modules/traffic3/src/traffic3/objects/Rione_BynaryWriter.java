...
public class Rione_BynaryWriter {
	...
	public Rione_BynaryWriter(File file) throws Exception {
		this.stream=new BufferedOutputStream(new FileOutputStream(file));
	}

	public Rione_BynaryWriter(File file, boolean isAppend) throws Exception {
